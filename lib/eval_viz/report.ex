defmodule EvalViz.Report do
  ...
  defp panel(:roc, :classification, y_true, y_score, _opts) do
    EvalViz.roc_curve(y_true, y_score, title: "ROC", width: 300, height: 260)
  end

  defp panel(:precision_recall, :classification, y_true, y_score, _opts) do
    EvalViz.precision_recall_curve(y_true, y_score,
  ...
  defp panel(:det, :classification, y_true, y_score, _opts) do
    EvalViz.det_curve(y_true, y_score, title: "DET", width: 300, height: 260)
  end

  defp panel(:threshold, :classification, y_true, y_score, _opts) do
    EvalViz.threshold_curve(y_true, y_score, title: "Threshold", width: 320, height: 260)
  end

  defp panel(:calibration, :classification, y_true, y_score, _opts) do
    EvalViz.calibration_curve(y_true, y_score, title: "Calibration", width: 300, height: 260)
  end
  ...
  defp panel(:residuals, :regression, y_true, y_pred, _opts) do
    EvalViz.residuals(y_true, y_pred, title: "Residuals", width: 300, height: 280)
  end
